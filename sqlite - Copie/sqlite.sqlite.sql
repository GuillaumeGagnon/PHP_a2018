...
INSERT INTO `users` (id,email,role,password,created,modified) VALUES (6,'admin@admin.com',2,'$2y$10$Z8v3k4rjJTt.LDhuXqznh.gjoJvFfZcp/GVq5JgIEDHh3FajXHKfOÔÅÄ',NULL,NULL),
...
INSERT INTO `trains` (id,name,origin_station,final_station,private,created,modified) VALUES (18,'TGV',10,12,0,'2018-10-12 02:19:40','2018-10-12 02:19:40'),
 ...
 (21,'test_recuperation_bd',10,10,0,'2018-11-15 04:37:17','2018-11-15 04:37:17');
...
INSERT INTO `stations` (id,name,type,created,modified) VALUES (10,'Cartier',1,NULL,NULL),
...
INSERT INTO `station_types` (id,type,description,created,modified) VALUES (1,'station_civile','Une station de train traditionnelle.','2018-10-04 19:35:09','2018-10-12 02:04:03'),
...
DROP TABLE IF EXISTS `station_sub_types`;
CREATE TABLE IF NOT EXISTS `station_sub_types` (
	`id`	INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT,
...
INSERT INTO `roles` (id,role_name) VALUES (1,'member'),
 (2,'admin');
...
INSERT INTO `phinxlog` (version,migration_name,start_time,end_time,breakpoint) VALUES (20181013033322,'Initial','2018-10-13 07:33:22','2018-10-13 07:33:22',0),
 (20181114194533,'Initiale','2018-11-15 00:45:34','2018-11-15 00:45:34',0);
...
INSERT INTO `passengers` (id,user_id,train_id,name,address,phone,other,created,modified) VALUES (1,19,19,'Guillaume Gagnon','6720 Rue Rivière','450-123-1234','test_member','2018-10-12 02:21:57','2018-10-12 02:21:57'),
...
CREATE TABLE IF NOT EXISTS `i18n` (
	...
	`foreign_key`	int ( 10 ) NOT NULL UNIQUE,

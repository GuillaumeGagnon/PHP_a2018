...
class PassengersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'other' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'utf8mb4_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'created' => ['type' => 'datetime', 'length' => null, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null],
        'modified' => ['type' => 'datetime', 'length' => null, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null],
        '_indexes' => [
            'train_key' => ['type' => 'index', 'columns' => ['train_id'], 'length' => []],
            'user_key' => ['type' => 'index', 'columns' => ['user_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'passengers_ibfk_1' => ['type' => 'foreign', 'columns' => ['train_id'], 'references' => ['trains', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
            'passengers_ibfk_2' => ['type' => 'foreign', 'columns' => ['user_id'], 'references' => ['users', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2018-10-05 13:18:03',
                'modified' => '2018-10-05 13:18:03'
            ],
        ];
        parent::init();
    }

 ...
 * @var \App\Model\Entity\StationType[]|\Cake\Collection\CollectionInterface $stationTypes
 */
...
<div class="stationTypes index large-9 medium-8 columns content">
    <h3><?= __('Station Types') ?></h3>
    <table cellpadding="0" cellspacing="0">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="actions">
                    <?= $this->Html->link(__('View'), ['action' => 'view', $stationType->id]) ?>
                    <?= $this->Html->link(__('Edit'), ['action' => 'edit', $stationType->id]) ?>
                    <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $stationType->id], ['confirm' => __('Are you sure you want to delete # {0}?', $stationType->id)]) ?>
                </td>
            </tr>
            <?php endforeach; ?>
        </tbody>
